...
export const ErrorToast: FC<Props> = ({msg ,handleCloseBtnClick}) => {
  return (
    <div className="col col-12 d-inline-flex px-3 align-items-center rounded justify-content-between shadow bg-danger mb-4 py-2 mx-auto" style={{maxWidth: '400px'}} id="error-toast" >
